...
def sample(mean_x, covariance_x, n_samples, const, B=None, B_sqrt=None, B_sqrt_inv=None):
    """
...
def empirical_moments(mean_x, covariance_x, const, n_samples, B=None, B_sqrt=None, B_sqrt_inv=None):
    """
