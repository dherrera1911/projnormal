...
from .ellipse_projnormal import ProjNormalEllipse, ProjNormalEllipseIso, ProjNormalEllipseFixed
...
class ProjNormalEllipseConstIso(ProjNormalEllipseIso):
    """
    This class implements the general projected normal distribution but with
    projection to the interior of an ellipse.
    The variable Y following the distribution
...
class ProjNormalEllipseConstFixed(ProjNormalEllipseFixed):
    """
    This class implements the general projected normal distribution but with
    projection to the interior of an ellipse.
    The variable Y following the distribution
